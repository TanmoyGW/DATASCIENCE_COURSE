...
% The fitness function called is MYPSOTESTFUNC. 
nDim = 30; %Dimensionality of the search space
rmin = -600;% lower bound of search space coordinate
rmax = 600; %Upper bound of search space coordinate
ffparams = struct('rmin',rmin,...
                     'rmax',rmax ...
                  );
% Fitness function handle.
fitFuncHandle = @(x) mypsotestfunc(x,ffparams);
